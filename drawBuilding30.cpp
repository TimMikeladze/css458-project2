...
void arch(int the_cut_num, double the_starting_degree, double the_degree_increase_ratio,double the_x, double the_y){
	glPushMatrix();
...
// over all.... rotate -15 for y
// rotate 105 for y, right face...
